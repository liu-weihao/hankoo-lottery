...
public class DateUtils {
    ...
    public static Boolean checkDate(LocalDate checkDate, LocalDate startDate, LocalDate endDate) {
        return !startDate.isAfter(checkDate) && !endDate.isBefore(checkDate);
    }
